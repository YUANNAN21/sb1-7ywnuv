...
const Products: React.FC = () => {
  ...
  const brands = ['西门子', 'ABB', '施耐德', '欧姆龙', '三菱电机', 'MacGregor'];
  const recentInquiries = [
    'ZA-3-1', '3RT1015-1BB42', 'A9F18240', '6ES7314-6CH04-0AB0', 'E3X-NA11',
    'FX3U-32MT/ES-A', 'LC1D09M7', '3RV2011-1JA10', 'PM554-T', 'CJ2M-CPU33',
    '1756-L73', 'S7-1200', 'RX3i', 'CP1H-X40DR-A', 'DVP14SS211R',
    'FX5U-32MT/ES', 'TM221CE40R', '1769-L33ER', 'CX9020', 'XGT'
  ];
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/3">
          ...
          <div className="bg-gray-100 p-4 rounded mb-4">
            ...
            <p className="text-sm text-gray-600 mb-2">输入您的订单号码，查看最新物流状态</p>
            <OrderTracking />
          </div>
        </div>
      </div>
